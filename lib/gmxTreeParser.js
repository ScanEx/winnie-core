...
// 1. Walk map config. Find gmxVector layers. Load them and save properties
// 2. Create gmx tree from config using map config keys and gmxVector layers properties
    ...
    function createRawTree(gmxLayers, mapConfig, lang) {
        ...
        function rCreateRawTree(l) {
            ...
            return {
                ...
                content: {
                    properties: l.gmxId ? L.extend(props, gmxLayers[l.gmxId.split(':')[1]]._gmx.properties, {
                        type: 'Vector'
                    }) : props,
